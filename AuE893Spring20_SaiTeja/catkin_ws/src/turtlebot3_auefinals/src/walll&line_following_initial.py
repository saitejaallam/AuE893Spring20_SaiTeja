...
class LineFollower(object):
    ...
    def camera_callback(self,data):
        ...
        try:
            ...
            line_finder = True
            print("entering zero division error")
        ...
        twist_object.angular.z = -float(err)/1500
            ...
            if line_confirm==False:
                ...
                if front_error>0:
                    if right_dist > left_dist:
                        twist_object.angular.z = -2*(front_error)
                        twist_object.linear.x = 0.1/(front_error+1)
